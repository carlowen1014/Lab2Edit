//Carl Owen
//Lab 2
//EventPanel class a GUI compenent that displays details on each event
    ...
    public EventPanel(Event event)
    {
        ...
        if (event instanceof Completable)
        {
            ...
            completeButton.addActionListener(e ->
            {
                ...
                completeButton.setEnabled(false);  //Disables the button after completion
            });
            add(completeButton);
        }
